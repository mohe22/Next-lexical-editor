    ...
    return (
      ...
      >
        {Loding && text ? (
          ...
          <span
            className="relative block h-full w-full font-mono font-bold text-sm uppercase tracking-wide text-[rgb(0,0,0,65%)] dark:font-light dark:text-[rgb(255,255,255,90%)]"
            style={{
              maskImage:
